...
```
```bash
uv pip install https://github.com/turboderp-org/exllamav3/releases/download/v0.0.22/exllamav3-0.0.22+cu128.torch2.8.0-cp310-cp310-win_amd64.whl
```
...
```
```bash
uv pip install https://github.com/turboderp-org/exllamav3/releases/download/v0.0.22/exllamav3-0.0.22+cu128.torch2.8.0-cp310-cp310-linux_x86_64.whl
```
